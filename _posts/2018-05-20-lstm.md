...
While Chris Olah's blog post (see above) provides an amazingly clear explanation of the LSTM, there remains several details and challenges in actually implementing the LSTM network, without the convenience of a `LSTM`/`LSTMCell` class.
