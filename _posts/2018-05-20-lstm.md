...
Long Short Term Memory (LSTM) networks comprise of a persistent cell state and a hidden state. In the context of the Counting Task, for the ideally-trained LSTM, this implies the following changes when each element/step is input.
